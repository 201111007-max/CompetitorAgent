...
from dota_helper.analyzers.base import estimate_tokens
from dota_helper.domain_types.state import ReviewAgentState
from dota_helper.domain_types.analysis import Conclusion
from dota_helper.domain_types.exceptions import (
    ReviewError,
    DataFetchError,
    LLMError,
...
class TestPython39Compatibility:
    ...
    def test_data_validation_error_optional(self) -> None:
        ...
        from dota_helper.data_source.exceptions import DataValidationError
...
# 需要导入以测试 P0-3
from dota_helper.data_source.exceptions import OpenDotaAPIError
