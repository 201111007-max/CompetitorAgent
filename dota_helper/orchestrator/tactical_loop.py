...
class TacticalLoop:
    ...
    async def execute(
        ...
        tracer = get_tracer()
        async with tracer.span("tactical.execute", phase=context.phase) as tactical_span:
            ...
            # 设置 span 属性
            tactical_span.set_attribute("iterations_used", iterations_used)
            tactical_span.set_attribute("tokens_consumed", tokens_consumed)
            tactical_span.set_attribute("confidence", best_result.confidence)
