...
from dota_helper.domain_types.enums import ReviewTerminalState
from dota_helper.domain_types.events import ProgressEvent, VerificationResult
...
class ReviewOrchestrator:
    ...
    def _create_error_report(self, match_id: str, error_msg: str) -> ReviewReport:
        ...
        Returns:
            ReviewReport: 错误报告
        """
        from dota_helper.domain_types.report import MatchSummary
