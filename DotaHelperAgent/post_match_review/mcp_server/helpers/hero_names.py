...
DotaHelperAgent project root) with an embedded fallback dictionary.
"""
...
def _resolve_data_dir() -> str:
    """Resolve the DotaHelperAgent project root and return the data directory.
    ...
    # (helpers/ -> mcp_server/ -> post_match_review/ -> DotaHelperAgent/)
